...
const v11Seeds: V11Seed[] = [
  ...
  ["things-to-do-in-orlando-this-weekend", "Things To Do in Orlando This Weekend: Family, Free & Attraction Ideas", "Plan things to do in Orlando this weekend with family attractions, events, free ideas, indoor backups, hotels, and practical activity guides.", "Things To Do in Orlando This Weekend", "weekend"],
  ["things-to-do-in-miami-this-weekend", "Things To Do in Miami This Weekend: Beaches, Events & Local Deals", "Plan things to do in Miami this weekend with beaches, events, food, free ideas, family activities, hotels, and waterfront plans.", "Things To Do in Miami This Weekend", "weekend"],
  ["things-to-do-in-tampa-this-weekend", "Things To Do in Tampa This Weekend: Waterfront, Family & Free Ideas", "Plan things to do in Tampa this weekend with waterfront events, family activities, free ideas, food, hotels, and Gulf Coast plans.", "Things To Do in Tampa This Weekend", "weekend"],
  ["things-to-do-in-jacksonville-this-weekend", "Things To Do in Jacksonville This Weekend: Beaches, Family & Free Ideas", "Plan things to do in Jacksonville this weekend with beaches, markets, family activities, free ideas, hotels, and Northeast Florida events.", "Things To Do in Jacksonville This Weekend", "weekend"],
